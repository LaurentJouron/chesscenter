...
from chesscenter.controllers.controller_tournament import ControllerTournament
from chesscenter.controllers.controller_player import ControllerPlayer
from chesscenter.views.view_menu import ViewMenu
    ...
    while stay:
        ...
        if option_choice == "1":
            ...
            if player_search_option == "1":
                ...
                new_player = (
                    ControllerPlayer.add_player_to_all_players_database()
                )
            ...
            tournament_search_option = (
                ViewMenu.print_tournament_search_options()
            )
