...
class ViewMenu:
    ...
    def print_welcome_page():
        ...
        welcome_message = pyfiglet.figlet_format("CHESS-CENTER")
        print(welcome_message)
        print(ViewMenu.line)
        print("AUTHOR : Laurent Jouron")
        print(ViewMenu.line)
    ...
    def print_first_option():
        ...
        start_tournament = pyfiglet.figlet_format(
            "NEW TOURNAMENT", font="digital"
        )
    ...
    def print_tournament_search_options():
        ...
        option_choice = input(
            "See all tournaments [1]    See tournament players [2]\n\n"
        )
