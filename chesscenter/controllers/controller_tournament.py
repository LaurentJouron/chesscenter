...
from chesscenter.views.view_tournament import ViewTournament
from chesscenter.controllers.controller_player import ControllerPlayer
from chesscenter.controllers.controller_match import ControllerMatch
from chesscenter.controllers.controller_round import ControllerRound
...
class ControllerTournament:
    ...
    def print_tournament_inputs():
        ...
        ViewTournament.start_tournament(
            tournament_inputs[0], tournament_inputs[1]
        )
    ...
    def generate_new_tournament():
        ...
        for i in range(1, 5):
            ...
            if len(ModelTournament.rounds_list) == 0:
                ...
                round_pairs = ModelTournament.generate_pairs_by_score(
                    ModelTournament, deserialized_players, pairs_list
                )
            ...
            for i in range(0, 4):
                ...
                match = ControllerMatch.print_winner_and_score(
                ...
                deserialized_match = ModelMatch.deserialize_match(
                    serialized_match
                )
            ...
            ControllerRound.print_round_results(
        ...
        for player in ModelPlayer.tournament_players:
            ControllerPlayer.recap_ranking(
        ...
        ViewTournament.print_tournament_results(
            tournament_inputs[0],
            tournament_inputs[1],
            start_date,
            end_date,
        ...
        serialized_tournament = ModelTournament.serialize_tournament(
            tournament
        )

        ModelTournament.save_tournament_to_tournaments_database(
    ...
    def search_tournament_by_name():
        ...
        name = name.title()
        results = ModelTournament.tournaments_database.search(
    ...
    def get_all_tournaments():
        ...
        if chunks is None:
            ...
            if see_details_or_not in "yY":
                ...
                ModelTournament.deserialize_matches_and_rounds(
                    searched_tournament
                )
